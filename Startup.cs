    ...
    public class Startup
{
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        var connectionString = "Server=tcp:fa20valdezjessehw3.database.windows.net,1433;Initial Catalog=fa20valdezjessehw3;Persist" +
                " Security Info=False;User ID=MISAdmin;Password=Jv082099;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection" +
                " Timeout=30;";  //paste your connection string from Azure in between the quotes.         services.AddDbContext<AppDbContext>(options => options.UseSqlServer(connectionString));         services.AddMvc();
